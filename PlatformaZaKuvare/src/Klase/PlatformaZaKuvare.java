...
public class PlatformaZaKuvare {
		//singleton praviii Tacoooooooooo!!!!!!!!!!!!!!!!!!!!!!!!!!!
	...
	private static PlatformaZaKuvare instanca;
    private PlatformaZaKuvare() {
        //teloo
    }
    public static PlatformaZaKuvare getInstance() {
        if (instanca == null) {
            instanca = new PlatformaZaKuvare();
        }
        return instanca;
    }
	
	//generisanje top liste kreatora
	public void generisanjeTLK() {
		
	}
	//generisanje top liste recepata
	public void generisanjeTLR() {
